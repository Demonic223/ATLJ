...
{$O+}
uses
  Player, Packets, SysUtils, AnsiStrings, Clipbrd, MMSystem, Generics.Collections,
  Winsock2, Math, System.Threading, System.SyncObjs, System.Classes;
type
...
begin
  Result := True; // 0 Não tem, 1 tem numérica, 2 trocar
  ...
  case Packet.RequestChange of
    ...
    1:
      if (AnsiCompareText(Packet.Numeric_1, Trim(Player.Account.Header.NumericToken[Packet.Slot])) = 0) and
    ...
    2:
      if (AnsiCompareText(Packet.Numeric_2, Trim(Player.Account.Header.NumericToken[Packet.Slot])) = 0) and
         (Player.Account.Header.NumError[Packet.Slot] < 5) then
      begin
        Player.Account.Header.NumericToken[Packet.Slot] := Packet.Numeric_1;
        Player.SaveCharOnCharRoom(Packet.Slot);
    ...
    begin
      ...
      begin // ir por targetid
        ...
        begin
          ...
          SQLComp.SetQuery(Format(
            ...
            EVENT_ITEM,
            OtherPlayer.Character.Base.CharIndex,
            Packet.ItemID,
            Packet.Amount
          ]));
          SQLComp.Query.Connection.StartTransaction;
      ...
      begin
        ...
        begin
          ...
          if (OtherPlayer = nil) then
          begin
            Continue; // ✅ Agora dentro de um for
          end;
