              ...
              begin
                ...
                begin
                  ...
                  Server.Devires[Slot].Slots[i].TimeCapped :=
                    UnixToDateTime(NationComp.Query.FieldByName('slot1_timecap')
                    .AsInteger);
                  TimeToEst :=
                    IncHour(UnixToDateTime(NationComp.Query.FieldByName
                    ('slot1_timecap').AsInteger), RELIQ_EST_TIME);
            ...
            1:
              begin
                ...
                begin
                  ...
                  ItemList[Server.Devires[Slot].Slots[i].ItemID].EFV[0];
                  Server.Devires[Slot].Slots[i].TimeCapped :=
                    UnixToDateTime(NationComp.Query.FieldByName('slot2_timecap')
                    .AsInteger);
                  TimeToEst :=
                    IncHour(UnixToDateTime(NationComp.Query.FieldByName
                    ('slot2_timecap').AsInteger), RELIQ_EST_TIME);
                  Server.Devires[Slot].Slots[i].TimeToEstabilish := TimeToEst;
                end;
                System.AnsiStrings.StrPLCopy(Server.Devires[Slot].Slots[i]
            ...
            2:
              begin
                ...
                begin
                  ...
                  ItemList[Server.Devires[Slot].Slots[i].ItemID].EFV[0];
                  Server.Devires[Slot].Slots[i].TimeCapped :=
                    UnixToDateTime(NationComp.Query.FieldByName('slot3_timecap')
                    .AsInteger);
                  TimeToEst :=
                    IncHour(UnixToDateTime(NationComp.Query.FieldByName
                    ('slot3_timecap').AsInteger), RELIQ_EST_TIME);
                  Server.Devires[Slot].Slots[i].TimeToEstabilish := TimeToEst;
                end;
                System.AnsiStrings.StrPLCopy(Server.Devires[Slot].Slots[i]
            ...
            3:
              begin
                ...
                begin
                  ...
                  ItemList[Server.Devires[Slot].Slots[i].ItemID].EFV[0];
                  Server.Devires[Slot].Slots[i].TimeCapped :=
                    UnixToDateTime(NationComp.Query.FieldByName('slot4_timecap')
                    .AsInteger);
                  TimeToEst :=
                    IncHour(UnixToDateTime(NationComp.Query.FieldByName
                    ('slot4_timecap').AsInteger), RELIQ_EST_TIME);
                  Server.Devires[Slot].Slots[i].TimeToEstabilish := TimeToEst;
                end;
                System.AnsiStrings.StrPLCopy(Server.Devires[Slot].Slots[i]
            ...
            4:
              begin
                ...
                begin
                  ...
                  ItemList[Server.Devires[Slot].Slots[i].ItemID].EFV[0];
                  Server.Devires[Slot].Slots[i].TimeCapped :=
                    UnixToDateTime(NationComp.Query.FieldByName('slot5_timecap')
                    .AsInteger);
                  TimeToEst :=
                    IncHour(UnixToDateTime(NationComp.Query.FieldByName
                    ('slot5_timecap').AsInteger), RELIQ_EST_TIME);
                  Server.Devires[Slot].Slots[i].TimeToEstabilish := TimeToEst;
                end;
                System.AnsiStrings.StrPLCopy(Server.Devires[Slot].Slots[i]
